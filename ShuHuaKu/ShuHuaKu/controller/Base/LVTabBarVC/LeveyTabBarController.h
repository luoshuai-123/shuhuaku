...
@interface LeveyTabBarController : SHBaseVC <LeveyTabBarDelegate>
{
	LeveyTabBar *_tabBar;
...
- (void)tabBarController:(LeveyTabBarController *)tabBarController refrshSelectIndex:(NSInteger )interSelcet;
